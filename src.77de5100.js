...
exports.Animation = exports.LinkType = void 0;
...
(function (LinkType) {
  LinkType[LinkType["Transition"] = 0] = "Transition";
  LinkType[LinkType["SuffixLink"] = 1] = "SuffixLink";
...
var Animation = /*#__PURE__*/function () {
  ...
  _createClass(Animation, [{
    ...
    key: "UpdateLinksData",
    value: function UpdateLinksData(links) {
      this.linksGroup = this.linksGroup.data(links, function (d) {
        return d.id;
      });
      this.linksGroup.exit().transition().attr('stroke-opacity', 0).attrTween('x1', function (d) {
        var link = d;
        return function () {
          var source = link.source;
          return source.x.toString();
        };
      }).attrTween('x2', function (d) {
        var link = d;
        return function () {
          var target = link.source;
          return target.x.toString();
        };
      }).attrTween('y1', function (d) {
        var link = d;
        return function () {
          var source = link.source;
          return source.y.toString();
        };
      }).attrTween('y2', function (d) {
        var link = d;
        return function () {
          var target = link.source;
          return target.y.toString();
        };
      }).remove();
      var linkEnter = this.linksGroup.enter().append('path').attr('id', function (d) {
        return d.id;
      }).attr('marker-end', 'url(#arrowMarker)').attr('class', 'link').call(function (link) {
        link.transition().attr('stroke-opacity', 1);
      });
      this.linksGroup = this.linksGroup.merge(linkEnter);
    }
  }, {
    key: "UpdateLinkLabelsData",
    value: function UpdateLinkLabelsData(links) {
      this.linkLabelsGroup = this.linkLabelsGroup.data(links, function (d) {
        return d.id;
      });
      this.linkLabelsGroup.exit().remove();
      var linkLabelEnter = this.linkLabelsGroup.enter().append('text').attr('class', 'linklabel').style('font-size', '17px').attr('dy', '-1').attr('text-anchor', 'middle').style('fill', '#000').append('textPath').attr('xlink:href', function (d) {
        return '#' + d.id;
    ...
    key: "RefreshNodesGroup",
    value: function RefreshNodesGroup() {
      this.nodesGroup.attr('transform', function (d) {
    ...
    key: "RefreshLinksGroup",
    value: function RefreshLinksGroup() {
      this.linksGroup.attr('d', function (link) {
        var _a, _b, _c, _d;

        var source = link.source;
        var target = link.target;
        var dx = target.x - source.x;
        var dy = target.y - source.y; // rotate 90 ccw

        var ndx = -dy;
        var ndy = dx;
        var middleX = 0.5 * (target.x + source.x);
        var middleY = 0.5 * (target.y + source.y);
        var px = middleX + 0.5 * ndx;
        var py = middleY + 0.5 * ndy;
        return 'M' + ((_a = source.x) === null || _a === void 0 ? void 0 : _a.toString()) + ',' + ((_b = source.y) === null || _b === void 0 ? void 0 : _b.toString()) + 'Q' + px + ',' + py + ' ' + ((_c = target.x) === null || _c === void 0 ? void 0 : _c.toString()) + ',' + ((_d = target.y) === null || _d === void 0 ? void 0 : _d.toString());
...
},{"d3":"../node_modules/d3/index.js"}],"animation_runner.ts":[function(require,module,exports) {
"use strict";
...
var AnimationRunner = /*#__PURE__*/function () {
  function AnimationRunner(simulation) {
  ...
  _createClass(AnimationRunner, [{
    key: "Start",
    value: function Start(events, timeout) {
      var _this = this;

      var index = 0;
      this.runningInterval = d3.interval(function () {
        if (index >= events.length) {
          _this.Stop();
        } else {
          _this.simulation.Step(events[index++]);
        }
      }, timeout);
    }
  }, {
...
},{"d3":"../node_modules/d3/index.js"}],"events.ts":[function(require,module,exports) {
"use strict";
...
(function (EventType) {
  EventType[EventType["CreateNewState"] = 0] = "CreateNewState";
  EventType[EventType["CreateClonedState"] = 1] = "CreateClonedState";
  EventType[EventType["CreateLink"] = 2] = "CreateLink";
  EventType[EventType["RemoveLink"] = 3] = "RemoveLink";
  EventType[EventType["CreateSuffixLink"] = 4] = "CreateSuffixLink";
  EventType[EventType["RemoveSuffixLink"] = 5] = "RemoveSuffixLink";
  EventType[EventType["Focus"] = 6] = "Focus";
  EventType[EventType["RemoveFocus"] = 7] = "RemoveFocus";
...
var Simulation = /*#__PURE__*/function () {
  ...
  _createClass(Simulation, [{
    ...
    key: "UpdateYStrength",
    value: function UpdateYStrength(strength) {
      var _this3 = this;
    ...
    value: function Refresh() {
      ...
      this.simulation.force('link', force); // Needed ???

      this.simulation.alpha(1).restart();
    }
  }, {
    key: "Step",
    value: function Step(event) {
      var _a, _b, _c, _d; // TODO: how to properly handle optional members in "strict" mode ???


      switch (event.type) {
        case events_1.EventType.CreateNewState:
        case events_1.EventType.CreateClonedState:
          {
            this.nodes.push({
        ...
        case events_1.EventType.CreateLink:
        case events_1.EventType.CreateSuffixLink:
          {
            var id = ((_a = event.attributes.source) === null || _a === void 0 ? void 0 : _a.toString()) + '-' + ((_b = event.attributes.target) === null || _b === void 0 ? void 0 : _b.toString());
            var type = event.type == events_1.EventType.CreateLink ? animation_1.LinkType.Transition : animation_1.LinkType.SuffixLink;
            this.links.push({
              id: id,
              source: event.attributes.source,
              target: event.attributes.target,
              type: type,
        ...
        case events_1.EventType.RemoveLink:
        case events_1.EventType.RemoveSuffixLink:
          {
            var _id = ((_c = event.attributes.source) === null || _c === void 0 ? void 0 : _c.toString()) + '-' + ((_d = event.attributes.target) === null || _d === void 0 ? void 0 : _d.toString());
        ...
        case events_1.EventType.RemoveFocus:
          {
            // FIXME
            if (event.attributes.stateID !== undefined) {
...
},{"d3":"../node_modules/d3/index.js","./animation":"animation.ts","./events":"events.ts"}],"suffix-automaton.ts":[function(require,module,exports) {
"use strict";
...
var SuffixAutomaton = /*#__PURE__*/function () {
...
var SuffixAutomatonBuilder = /*#__PURE__*/function () {
  ...
  _createClass(SuffixAutomatonBuilder, [{
    ...
    value: function CreateClonedState(from, maxLength) {
      ...
      state.go.forEach(function (nextState, label) {
        _this.history.push({
...
var animation_runner_1 = require("./animation_runner");
